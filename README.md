...
| instance_networks_configuration | The private networks configuration to attach to the instance resource | <pre>list(object({<br>  uuid              = string<br>  fixed_ip_v4       = optional(string, "")<br>  ipv6_enable       = optional(bool, null)<br>  source_dest_check = optional(bool, null)<br>  access_network    = optional(bool, null)<br>}))</pre> | <pre>[]</pre> | N |
